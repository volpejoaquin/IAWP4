<div id="content"><div class="ic">More Website Templates at TemplateMonster.com!</div>
	...
	<div class="content">
		...
		<ul class="movies">
			<li>
				<h4>Toy Story 3</h4><img src="img/1page-img2.jpg" alt="" />
			...
			<li>
				<h4>Prince of Percia: Sands of Time</h4><img src="img/1page-img3.jpg" alt="" />
			...
			<li class="last">
				<h4>The Twilight Saga: Eclipse</h4><img src="img/1page-img4.jpg" alt="" />
